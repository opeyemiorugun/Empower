...
def app():
    ...
    base_url = "https://raw.githubusercontent.com/<username>/<repository>/main/"  # Adjust the URL based on your repository structure
    label_file_url = base_url + "labels.dat"
    weather_file_url = base_url + "weather.csv"
    csv_files_urls = [base_url + f"appliance_{i}.csv" for i in range(1, 6)]  # Adjust the filenames as per your repository
